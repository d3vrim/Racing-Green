...
static void test_1(void)
{
  ...
  CAN2.mailbox_set_datah(0, 0x11223344); // byte 7-4
  CAN2.mailbox_set_datal(0, 0x55667788); // byte 3-0
  ...
  Serial.println(inFrame.data[0],HEX);
  Serial.println(inFrame.data[1],HEX);
  Serial.println(inFrame.data[2],HEX);
  Serial.println(inFrame.data[3],HEX);
  Serial.println(inFrame.data[4],HEX);
  Serial.println(inFrame.data[5],HEX);
  Serial.println(inFrame.data[6],HEX);
  Serial.println(inFrame.data[7],HEX);
